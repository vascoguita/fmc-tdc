...
define_output_delay     {p:start_from_fpga_o}   1.00 -ref tdc_clk125:r
define_output_delay     {p:cs_n_o}              1.00 -ref tdc_clk125:r
define_output_delay     {p:rd_n_o}              1.00 -ref tdc_clk125:r
define_output_delay     {p:wr_n_o}              1.00 -ref tdc_clk125:r
...
define_false_path       -to     {p:term_en_1_o}
define_false_path       -to     {p:term_en_2_o}
define_false_path       -to     {p:term_en_3_o}
define_false_path       -to     {p:term_en_4_o}
define_false_path       -to     {p:term_en_5_o}
define_false_path       -to     {p:mute_inputs_o}
